Feature: TestingAmountTransactions
	...
	Scenario: Perform an 102001 Invalid Amount Transaction
		...
		Given the user prepares the API "ErrorCodes/102001InvalidAmount" request   
	...
	Scenario: Perform an 102002 Invalid Client Id
		...
		Given the user prepares the API "ErrorCodes/102002InvalidClientId" request   
		When a POST request is performed
		Then the response code will be response code '400'
	...
	Scenario: Perform an 102003 Invalid Client Bank Transit Number
		...
		Given the user prepares the API "ErrorCodes/102003InvalidClientBankTransitNumber" request   
		When a POST request is performed
		Then the response code will be response code '400'
	...
	Scenario: Perform an 102004 Invalid Client Bank Account Number
		...
		Given the user prepares the API "ErrorCodes/102004InvalidClientBankAccountNumber" request   
		When a POST request is performed
		Then the response code will be response code '400'
	...
	Scenario: Perform an 102005 Invalid Reference Number
		...
		Given the user prepares the API "ErrorCodes/102005InvalidReferenceNumber" request   
		When a POST request is performed
		Then the response code will be response code '400'
	...
	Scenario: Perform an 102006 Duplicate Reference Number
		...
		Given the user prepares the API "ErrorCodes/102006DuplicateReferenceNumber" request   
		When a POST request is performed
		Then the response code will be response code '400'
	...
	Scenario: Perform an 102007 Invalid Client Id
		...
		Given the user prepares the API "ErrorCodes/102007InvalidClientId" request   
		When a POST request is performed
		Then the response code will be response code '400'
	...
	Scenario: Perform an 102008 Invalid Effective Date
		...
		Given the user prepares the API "ErrorCodes/102008InvalidEffectiveDate" request   
		When a POST request is performed
		Then the response code will be response code '400'
	...
	Scenario: Perform an 102009 Refund No Match
		...
		Given the user prepares the API "ErrorCodes/102009RefundNoMatch" request   
		When a POST request is performed
		Then the response code will be response code '400'
	...
	Scenario: Perform an 102010 Amount Exceeds Risk Threshold
		...
		Given the user prepares the API "ErrorCodes/102010AmountExceedsRiskThreshold" request   
		When a POST request is performed
		Then the response code will be response code '400'
	...
	Scenario: Perform an 102016 MTD Count Exceeds Limit
		...
		Given the user prepares the API "ErrorCodes/102016MTDCountExceedsLimit" request   
		When a POST request is performed
		Then the response code will be response code '400'
	...
	Scenario: Perform an 102017 MTD Amount Exceeds Limit
		...
		Given the user prepares the API "ErrorCodes/102017MTDAmountExceedsLimit" request   
		When a POST request is performed
		Then the response code will be response code '400'
